...
def create_model(dropout_rate=0.0):
    ...
    model=Sequential()
    model.add(Dense(num_classes*4 , input_dim=3, kernel_initializer='he_normal', activation='relu'))
...
def main():
    ...
    #batch_size = [10]
    dropout_rate = [0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5]
